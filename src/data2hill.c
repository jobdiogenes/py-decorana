/*********************************************************
 ...
 code come from R vegan adapt to python
**********************************************************/
...
static PyObject* do_decorana(PyObject *self, PyObject *args)
// veg, SEXP ira, SEXP iresc, SEXP rshort, SEXP imk,		 SEXP aidot, SEXP adotj)
{
    /* decorana CONSTANTS */
    int NAXES = 4, MKPAD = 4;
    double ZEROEIG = 1e-7;
